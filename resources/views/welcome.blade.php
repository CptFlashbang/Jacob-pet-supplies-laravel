    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div class="text-center p-6 bg-green-100 dark:bg-green-900 text-gray-900 dark:text-white rounded-xl shadow-md">
                    <h1 class="text-3xl font-bold mb-2">Welcome to Jacob Pet Supplies</h1>
                    <p class="text-lg text-gray-700 dark:text-gray-300">{{ $seasonalMessage }}</p>
                </div>

                <div class="mt-10">
                    <h2 class="text-2xl font-semibold text-center mb-6 text-gray-900 dark:text-gray-100">Featured Products</h2>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        @foreach ($randomProducts as $product)
                            <div class="bg-white dark:bg-gray-800 border dark:border-gray-700 p-4 rounded shadow text-center text-gray-900 dark:text-gray-100">
                ...
                <section class="hero p-8 text-left flex flex-col md:flex-row justify-between items-center text-gray-900 dark:text-gray-100">
                    <div class="flex-col">
                        ...
                        <div class="flex">
                            <div class="flex-col justify-center">
                                <p class="text-lg mb-6 mr-6 text-gray-700 dark:text-gray-300">
